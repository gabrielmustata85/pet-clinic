...
* The original package name 'com.example.pet-clinic' is invalid and this project uses 'com.example.petclinic' instead.
...
* [Building REST pet.clinic.services with Spring](https://spring.io/guides/tutorials/bookmarks/)
