...
import pet.clinic.repositories.PetTypeRepository;
...
public class PetController {
    ...
    public PetController(PetService petService, OwnerService ownerService, PetTypeRepository petTypeRepository, PetTypeService petTypeService) {
